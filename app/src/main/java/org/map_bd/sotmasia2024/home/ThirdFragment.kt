...
import org.map_bd.sotmasia2024.api.Day1Room2
...
class ThirdFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val firstView: View = inflater.inflate(R.layout.fragment_third, container, false)

        rvMain =firstView.findViewById(R.id.recycler_view3)
