...
import org.map_bd.sotmasia2024.api.Day2Roommain
...
class FiveFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val firstView: View = inflater.inflate(R.layout.fragment_five, container, false)

        rvMain =firstView.findViewById(R.id.recycler_view5)
    ...
    private fun getAllData() {
        ...
        var retrofit = Retrofit.Builder()
            ...
            .build()
            .create(Day2Roommain::class.java)
