...
import org.map_bd.sotmasia2024.api.Day1Room3
...
class FourthFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val firstView: View = inflater.inflate(R.layout.fragment_fourth, container, false)

        rvMain =firstView.findViewById(R.id.recycler_view4)
