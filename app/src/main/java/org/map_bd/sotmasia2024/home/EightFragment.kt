...
import org.map_bd.sotmasia2024.api.Day2Room3
...
class EightFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val firstView: View = inflater.inflate(R.layout.fragment_eight, container, false)

        rvMain =firstView.findViewById(R.id.recycler_view8)
