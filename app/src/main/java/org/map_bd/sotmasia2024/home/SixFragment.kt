...
import org.map_bd.sotmasia2024.api.Day2Room1
...
class SixFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val firstView: View = inflater.inflate(R.layout.fragment_six, container, false)

        rvMain =firstView.findViewById(R.id.recycler_view6)
