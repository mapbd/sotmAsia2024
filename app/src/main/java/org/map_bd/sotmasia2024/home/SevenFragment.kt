...
import org.map_bd.sotmasia2024.api.Day2Room2
...
class SevenFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val firstView: View = inflater.inflate(R.layout.fragment_seven, container, false)

        rvMain =firstView.findViewById(R.id.recycler_view7)
